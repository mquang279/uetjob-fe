...
const CompanyInfo = ({ company, isLoading, error }) => {
    ...
    if (!company) {
        return (
            <div className="bg-white rounded-lg inset-shadow-xs row-span-3 p-4 flex items-center justify-center">
    ...
    return (
        <div className="bg-white rounded-lg inset-shadow-xs p-4 h-fit">
