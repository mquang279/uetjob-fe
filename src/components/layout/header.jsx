...
const Header = () => {
    return (
        <div className="header w-full">
            <div className="container sticky top-0 bg-[linear-gradient(90deg,rgba(20,20,20,1)_55%,rgba(110,21,25,1)_100%,rgba(0,212,255,1)_100%)] text-white w-full h-[70px] flex justify items-center px-[30px] border-b-[0.5px] border-gray-600">
                ...
                <div className="header-action flex text-nowrap font-medium gap-8">
                    <NavLink className="w-full hover:underline cursor-pointer">For Employers</NavLink>
